...
@endif
                                    ...
                                    <div class="d-flex justify-content-end mb-3">
                                        ...
                                        <a href="{{ route('admin.achivement.create') }}" class="btn btn-success btn-sm">
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    @if($achive->image)
                                                        <img src="{{ asset('storage/' . $achive->image) }}" width="50"
                                                            height="50" class="rounded" alt="{{ $achive->name }}">
                                                        @else
                                                        No Image
                                                        @endif
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.doctor.achivement.edit',$achive->id) }}" class="btn btn-sm btn-primary">
                                                            Edit
                                                        </a>
                                                        ...
                                                        <a href="{{ route('admin.doctor.achivement.delete',$achive->id) }}"
