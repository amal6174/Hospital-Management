                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            ...
                            <div class="card">
                                ...
                                <div class="d-flex justify-content-end mb-3">
                                    ...
                                    {{-- <a href="{{ route('admin.doctor.create.page') }}" class="btn btn-success btn-sm">
                        ...
                        @endif --}}
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="badge bg-primary">
                                                            {{ $appointment->category->category_name ?? 'N/A' }}
                                                        </span>
                        ...
                        {{ $doctor->designation }}
                                                    ...
                                                    <td>
                                                        <select class="form-select form-select-sm status-select"
                                                            ...
                                                            <option value="compleate"
                                                                {{ $appointment->status === 'compleate' ? 'selected' : '' }}>
                                                                Completed
                                                            </option>
                                                    ...
                                                    <td class="status-updated-by" data-id="{{ $appointment->id }}">
                                                        {{ $appointment->statusUpdatedBy?->name ?? 'Not Updated' }}
                                                    </td>
