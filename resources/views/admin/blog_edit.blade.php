                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-description">Update Blog</p>
                                    ...
                                    <form class="forms-sample"
                                          action="{{ route('admin.blog.update', $blogs->id) }}"
                                          method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="small_description"
                                                      ...
                                                      placeholder="Enter Small Description">{{ old('small_description', $blogs->small_description) }}</textarea>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description"
                                                      ...
                                                      placeholder="Enter Description">{{ old('description', $blogs->description) }}</textarea>
                                            @error('description')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        ...
                                        <a href="{{ route('admin.blog.view') }}" class="btn btn-light">Cancel</a>
