                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="forms-sample"
                                        action="{{ route('admin.category.update',$categories->id) }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            @if($categories->image)
                                            <img src="{{ asset('categories/'.$categories->image) }}" width="100"
                                                height="100" class="img-thumbnail" style="object-fit:cover;">
                                            @else
                                        ...
                                        <a href="{{ route('admin.view.categories') }}?page={{$page}}" class="btn btn-light">Cancel</a>
