...
@endif
                                    ...
                                    <div class="d-flex justify-content-end mb-3">
                                        ...
                                        <a href="{{ route('admin.file.create') }}" class="btn btn-success btn-sm">
                                 ...
                                 @foreach($files as $file)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        {{-- <a href="{{ Storage::url($file->document) }}" target="_blank">
                                                                View Document
                                                         </a> --}}
                                                    ...
                                                    <td>
                                                     <a href="{{ route('file.dwonload',$file->id) }}">Dwonload Here</a>

                                                    </td>

                                                    <td>
                                                       <a
                href="{{ route('file.read', $file->id) }}"
                target="_blank"
            ...
            >
                Read File
                                                    ...
                                                    <td>
<a href="{{ route('files.copy', $file->id) }}"
   class="btn btn-primary">
    Copy File
</a>
