                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    @endif
                                    <form class="forms-sample" action="{{ route('admin.partner.update',$partner->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="radio" name="status" value="1" {{ $partner->status == 1 ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check">
                                                ...
                                                <input type="radio" name="status" value="0" {{ $partner->status == 0 ? 'checked' : '' }}>
