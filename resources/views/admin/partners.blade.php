...
@endif
                                    ...
                                    <div class="d-flex justify-content-end mb-3">
                                        ...
                                        <a href="{{ route('admin.partner.create') }}" class="btn btn-success btn-sm">
                                                ...
                                                <tr>
                                                    ...
                                                    @if($partner->image)
                                                        <img src="{{ asset('storage/' . $partner->image) }}" width="50"
                                                            height="50" class="rounded" alt="{{ $partner->name }}">
                                                        @else
                                                        No Image
                                                        @endif
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.partner.edit',$partner->id) }}" class="btn btn-sm btn-primary">
                                                            Edit
                                                        </a>
