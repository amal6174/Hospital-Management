...
<head>
    ...
    <title>Skydash Admin — Add Term</title>
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title">Add Term &amp; Condition</h4>
                                <p class="card-description">Create a new term to display on the frontend</p>
                                ...
                                <form class="forms-sample"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor"
                                                  ...
                                                  placeholder="Enter term description">{{ old('description') }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2">
                                        <i class="ti-save mr-1"></i> Save Term
                                    </button>
