...
<head>
  ...
  <link rel="stylesheet" href="vendors/ti-icons/css/themify-icons.css"> -->
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/jquery/4.0.0/jquery.min.js">
                                ...
                                <div class="">
                                    ...
                                    <h4 class="card-title mb-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <form action="{{ route('admin.view_categories') }}" method="GET"
                                                class="me-2">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div id="category-list" class="table-responsive">
