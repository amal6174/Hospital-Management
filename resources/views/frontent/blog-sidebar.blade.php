...
<section class="page-title bg-1"
        style="background: url('{{ asset('storage/'.$page_content['image_1']) }}')"
        no-repeat 50% 50%;
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="{{ route('blog-single',$blog->slug) }}">{{$blog->title}}</a></h2>

				<p class="mb-4">{{ $blog->small_description}}</p>
...
{{--
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			<div class="blog-thumb">
				<img src="{{ asset('storage/'.$page_content['image_3']) }}" alt="" class="img-fluid">
			</div>
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="blog-single.html">{{$page_content['title_3']}}</a></h2>

				<p class="mb-4">{{$page_content['description_2']}}</p>
	...
	<div class="col-lg-12 col-md-12 mb-5">
		<div class="blog-item">
			...
			<div class="blog-item-content">
				...
				<h2 class="mt-3 mb-3"><a href="blog-single.html">{{ $page_content['title_4']}}</a></h2>

				<p class="mb-4">{{$page_content['description_3']}}</p>
    ...
    <div class="col-lg-8">
        <nav class="pagination py-2 d-inline-block">
            <div class="nav-links">
                ...
                @else
                    <a class="page-numbers" href="{{ $blogs->previousPageUrl() }}">
                        <i class="icofont-thin-double-left"></i>
                    </a>
                @endif
                ...
                @if ($blogs->hasMorePages())
                    <a class="page-numbers" href="{{ $blogs->nextPageUrl() }}">
