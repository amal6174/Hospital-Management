...
<section class="page-title bg-1"
 style="
    background-image: url('{{ asset('storage/'.$page_content['image_1']) }}');
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <!-- form start -->
                <form id="contact-form" class="contact__form " method="post" action="{{ route('contact.insert') }}">
                 <!-- form message -->
                 @csrf
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="text-center">
                        ...
                        <button class="btn btn-main btn-round-full" name="submit" type="submit" >Send Messege"</button>
                    </div>
                </form>
            </div>
        </div>
